        ...
        <Flex direction="row" w="100%">
          ...
          >
            <Stack alignItems="flex-start">
              <Text fontFamily="code" fontSize="s" fontWeight="regular">
                LINES/MIN
              </Text>
            ...
            <Stack alignItems="flex-start">
              ...
              <HStack>
                ...
                <CircularProgress
                  value={props.stats.acc}
                  size="75px"
                  thickness={15}
                  color={useColorModeValue("light.lightGrey", "dark.lightblue")}
                />
              </HStack>
            </Stack>
          </Flex>
          ...
          <Stack alignItems="center" gap={8}>
            ...
            <Button
              ...
              color={useColorModeValue("light.extraLight", "dark.extralight")}
              w="70%"
              borderRadius={15}
              leftIcon={<ChatGPTIcon />}
              _hover={{
                bg: useColorModeValue("light.lightGrey", "blue.600"),
              }}
            >
              ChatGPT Says...
            </Button>
            ...
            >
              ...
              >
                ...
                <ModalCloseButton />
                <ModalBody>{props.gptSays}</ModalBody>
                <ModalFooter>
        ...
        <HStack gap={4} alignItems="flex-end">
          <Stack alignItems="center" gap={4}>
            <Stack alignItems="center" gap={-1}>
              <Text variant={"label"}>CODING LANGUAGE</Text>
              <Menu>
                <MenuButton
                  bg={useColorModeValue("light.darkGrey", "#77A3CD")}
                  as={Button}
                  fontSize="sm"
                  borderRadius={30}
                  height={6}
                ...
                <MenuList>
                  {props.languages.map((lang, i) => {
                    return (
                      <MenuItem key={i} onClick={() => props.setCurrLang(lang)}>
                        {lang}
                      </MenuItem>
                    );
                  })}
